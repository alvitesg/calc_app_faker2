...
from app.calculations import Calculations  # Manages history of calculations
from app.operations import add, subtract, multiply, divide  # Arithmetic operations
from app.calculation import Calculation  # Represents a single calculation
